...
from hwm.gym_minigrid_2.wrappers import RGBImgFullGridWrapper, ChannelFirstImgWrapper, \
    RGBImgResizeWrapper, ActionMaskingWrapper, FactoredStateRepWrapper
...
ENV_NAME = "MiniGrid-FourRooms-Size9-v0"
...
model.learn(total_timesteps=1000000, tb_log_name=f"PPO_CNN_FullImgObs_{ENV_NAME}")
